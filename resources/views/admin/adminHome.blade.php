                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="chart-area">
                                ...
                                <canvas id="myAreaChart" style="display: block; height: 320px; width: 480px;" width="960"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="chart-pie pt-4 pb-2">
                                ...
                                <canvas id="myPieChart" style="display: block; height: 245px; width: 324px;" width="648"
                                    height="490" class="chartjs-render-monitor"></canvas>
                            </div>
